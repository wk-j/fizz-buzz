...
Console.WriteLine(String.Format("{0,30} = {1,-70} ", "1/3.0", DoubleConverter.ToExactString(1 / 3.0)));
Console.WriteLine(String.Format("{0,30} = {1,-70} ", "1/3.0 + 1/3.0", DoubleConverter.ToExactString(1 / 3.0 + 1 / 3.0)));
